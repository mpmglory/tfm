...
<!--[if gt IE 9]><!-->	<html> <!--<![endif]-->
	...
	<body class="enable-animation">
		...
		<div id="wrapper">
            ...
            <!-- /HEADER -->
			<!-- -->
			<section id="slider" class="fullheight" style="background:url('assets/images/new/foret.JPG');">
				...
				<div class="display-table">
					<div class="display-table-cell vertical-align-middle">
						<div class="container text-center">
							...
							<h1 class="margin-bottom-20 size-40 margin-top-80">CETTE PAGE N'EST PAS ENCORE DISPONIBLE</h1>
							<p class="size-20 font-lato text-muted">Nous vous prions de patienter encore. Nous bossons dur</p>
							...
							<div style="max-width:500px; margin:auto;">
								...
								<form class="validate nomargin" action="php/newsletter.php" method="post" data-success="Subscribed! Thank you!" data-toastr-position="top-right">
									<div class="input-group">
										...
										<input type="email" id="email" name="email" class="form-control required" placeholder="Laissez votre e-mail">
