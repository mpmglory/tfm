	...
	<body class="smoothscroll enable-animation" >
		...
		<div id="wrapper">
			...
			<section class="page-header page-header-xs parallax parallax-3" style="background-image:url('assets/images/new/hd/3.jpg')">
				...
				<div class="container">
					<h1 class="uppercase">nos services</h1>
				</div>
			</section>
			<!-- /PAGE HEADER -->
			...
			<section>
				<div class="container">
					...
					<header class="text-center">
						...
						<p class="font-lato size-20 nomargin">Nous tenons vraiment à la satisfaction de nos clients</p>
					</header>
					...
					<div class="tab-content margin-top-30">
                                    ...
                                    <article class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="owl-carousel buttons-autohide controlls-over nomargin" data-plugin-options='{"items": 1, "autoHeight": true, "navigation": true, "pagination": true, "transitionStyle":"backSlide", "progressBar":"true"}'>
                                                <div>
                                                    <img class="img-responsive" src="assets/images/new/bois1.jpg" alt="">
                                                </div>
                                                <div>
                                                    <img class="img-responsive" src="assets/images/new/bois2.jpg" alt="">
                                                </div>
                                                <div>
                                                    <img class="img-responsive" src="assets/images/new/bois22.jpg" alt="">
                                                </div>
                                                <div>
                                                    <img class="img-responsive" src="assets/images/new/bois222.jpg" alt="">
                                                </div>
                                            </div>
                                            <!-- /OWL SLIDER -->
                                        </div>
                                        <div class="col-md-6">
                                            <h3>TFM: Specialiste de la Gestion des Forêts tropicales.</h3>
						...
						<div class="tab-pane" id="step2">
							<strong>Expertise Environnementale</strong>  denim you probably haven't 
                            heard of them jean shorts Austin. Nesciunt tofu stumptown aliqua, retro synth master cleanse.
						...
						<div class="tab-pane" id="step4">
                            ...
                            <section>
                                <div class="container">
                                    ...
                                    <header class="text-center">
                                        <h2 class="nomargin">TFM</h2>
                                        <p class="font-lato size-20 nomargin">Notre expertise a fortement contribué à la ruéssite de ces projets.</p>
                                    </header>
                                    ...
                                    <div class="row margin-top-80">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-md-push-4 text-center">
                                            ...
                                            <img class="img-responsive" src="assets/images/new/texture.jpg" alt="" />
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-md-pull-4">
                                            ...
                                            <div class="box-icon box-icon-right">
                                                ...
                                                <p>Description du projet en qulques mots.
                                                Description du projet en qulques mots.
                                                Description du projet en qulques mots.</p>
                                            </div>
						...
						<div class="tab-pane" id="step5">
							<strong>Appui Institutionnelle</strong>  cliche tempor, williamsburg carles vegan helvetica.
                        ...
                        <div class="tab-pane" id="step6">
							<div class="row">
                                <div class="col-md-6">
                                    <h3 class="size-20">Pourquoi vous devez choisir nos formations?</h3>
                                ...
                                <div class="col-md-6">
                                    <h3 class="size-20 text-center">Ils témoignent</h3>
                                    <!-- 
                                    ...
                                    <ul class="row clearfix testimonial-dotted list-unstyled">
                                        <li class="col-md-6">
                                            <div class="testimonial">
                                                <figure class="pull-left">
                                                    <img class="rounded" src="assets/images/new/300x300/2-min.jpg" alt="" />
                                                </figure>
                                        ...
                                        <li class="col-md-6">
                                            <div class="testimonial">
                                                <figure class="pull-left">
                                                    <img class="rounded" src="assets/images/new/300x300/6-min.jpg" alt="" />
                                                </figure>
                                                <div class="testimonial-content">
                                                    <p>Incidunt deleniti blanditiis quas aperiam recusandae consequatur ullam!</p>
                                                    <cite>
                        ...
                        <div class="tab-pane" id="step7">
							<strong>Changement climatique</strong>  cliche tempor, williamsburg carles vegan helvetica.
                            Reprehenderit butcher retro keffiyeh dreamcatcher synth. Cosby sweater eu banh mi,
                            qui irure terry richardson ex squid. Aliquip placeat salvia cillum iphone.
                            Seitan aliquip quis cardigan american apparel, butcher voluptate nisi qui.
						</div>
